      ...
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center">
          ...
          <nav className="hidden md:flex items-center space-x-8 text-sm font-medium">
            ...
            <Link className="text-zinc-400 hover:text-white transition-colors" href="/#workspace">
              Workspace
            </Link>
        ...
        <div className="hidden md:flex items-center space-x-4">
          {isLoggedIn ? (
            ...
            <>
              ...
              <Button 
                size="sm" 
                className="bg-white text-black font-semibold hover:bg-zinc-100 hover:scale-105 transition-all shadow-[0_0_15px_rgba(255,255,255,0.3)] hover:shadow-[0_0_25px_rgba(255,255,255,0.5)] border border-transparent hover:border-white/50"
                onClick={() => {
      ...
      {isOpen && (
        <div className="md:hidden fixed inset-0 top-16 z-50 bg-black border-t border-white/10 p-6 animate-in slide-in-from-top-5 fade-in-20">
          <nav className="flex flex-col space-y-6">
            ...
            <button
              className="text-lg font-medium text-white transition-colors text-left"
              onClick={() => {
                setIsOpen(false);
                const element = document.getElementById("pricing");
                element?.scrollIntoView({ behavior: "smooth" });
